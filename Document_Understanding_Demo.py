...
COMPARTMENT_ID = "ocid1.compartment.oc1..aaaaaaaaxsppaf4x6qpxm................."  # e.g. "ocid1.compartment.oc1..aaaaaaaae5j73axsja5fnahbn23ilop3ynjkcg77mcvgryddz4pkh2t5ppaq";
...
object_location.namespace_name = "idi1o....."  # e.g. "axhh9gizbq5x"
object_location.bucket_name = "Bucket-Origem..."  # e.g "demo_examples"
object_location.object_name = "doc......"  # e.g "text_detection_extraction_demo.jpg"

# Setup the output location where processor job results will be created
output_location = oci.ai_document.models.OutputLocation()
output_location.namespace_name = "......"  # e.g. "axk2tfhlrens"
output_location.bucket_name = "Bucket...."  # e.g "output"
output_location.prefix = "resultado"  # e.g "demo"
